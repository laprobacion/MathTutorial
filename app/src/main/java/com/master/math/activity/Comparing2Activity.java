...
public class Comparing2Activity extends AppCompatActivity {
    ...
    private void setFirstOnclick(){
        similarDenominators.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent lesson1Intent = new Intent(Comparing2Activity.this, FractionActivity.class);
                ...
                showGif(0,Comparing2Activity.this);
            }
        });
    }
